  ...
  return (
    <section className="w-full py-20 bg-white dark:bg-gray-950">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center">
        <h2 className="text-5xl font-extrabold text-center mb-4 text-gray-900 dark:text-white">Ready-to-go Templates</h2>
        ...
        <Link href="#" className="mb-12 px-8 py-3 rounded-lg bg-[#2563eb] text-white font-semibold text-lg hover:bg-[#1d4ed8] transition flex items-center gap-2 dark:bg-[#1d4ed8] dark:hover:bg-[#2563eb]">
          View all templates
          ...
          <div className="relative w-full">
            <div className="flex gap-8 animate-marquee-template whitespace-nowrap">
              {[...templates, ...templates].map((tpl, idx) => (
                <div key={tpl.alt + idx} className="rounded-2xl shadow-lg bg-white dark:bg-gray-900 flex-shrink-0" style={{ width: 320 }}>
